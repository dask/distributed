    ...
    **kwargs:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        scheduler_info_update = parse_timedelta(
            dask.config.get("distributed.client.scheduler-info-update")
        )

        self._periodic_callbacks = dict()
        self._periodic_callbacks["scheduler-info"] = PeriodicCallback(
            self._update_scheduler_info, scheduler_info_update * 1000, io_loop=self.loop
        )
