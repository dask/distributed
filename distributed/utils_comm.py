...
@gen.coroutine
def scatter_to_workers(ncores, data, report=True, serialize=True, connection_kwargs=None):
    ...
    rpcs = {addr: rpc(addr, connection_kwargs=connection_kwargs) for addr in d}
    try:
